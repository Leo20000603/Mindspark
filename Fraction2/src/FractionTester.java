...
public class FractionTester {
	...
	public static void testAdd(){
		...
		f1 = new Fraction(3,5);
		f2 = new Fraction(7,5);
		System.out.println("3/5+7/5 is... Expected Answer: 50/25, Your Solution: " +f1.add(f2));
		f1 = new Fraction(1,2);
	...
	public static void testEquals(){
		...
		f1 = new Fraction(4,2);
		System.out.println("4/2 equals 2 Expected Answer: False, Your Solution: " +f1.equals(3));
		System.out.println("Complete\n\n");
	}
	...
	public static void testMultiply(){
		...
		f1 = new Fraction(4,2);
		System.out.println("4/2*2 is... Expected Answer: 8/2, Your Solution: " +f1.multiply(2));
		System.out.println("Complete\n\n");
	}
